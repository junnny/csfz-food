...
/***/ function(module, exports, __webpack_require__) {
	...
	var $endOrder = (0, _vendorJquery2['default'])('#endOrder');

	$endOrder.click(function () {
	    _componentUi2['default'].dialog({
	        title: '确认结束本次点餐？',
	        onCertain: function onCertain() {
	            _vendorJquery2['default'].post('/order/end', function (response) {
	                if (response.code === _componentConstants2['default'].resCode.COMMON) {
	                    location.reload();
	                } else {
	                    _componentUi2['default'].tip({ content: '没有操作权限' });
	                }
	            });
	        }
	    });
	 ...
	 * banner slides
	 */
	new _vendorSwiper2['default']('.swiper-container', {
	    autoplay: 3000,
	    loop: true,
